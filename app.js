...
$(function () {
  ...
  $("#exercise2Button").on("click", function () {
    $("#exercise2 p").parent("div").css("background-color", "blue");
  });
  ...
  $("#exercise4Button").on("click", function () {
    $(this).parent().children("p").last().hide();
  });
  ...
  $("#exercise5Button").on("click", function () {
    $(this).next().find("p").css("border", "1px solid black");
  });
  ...
  $("#exercise6Button").on("click", function () {
    $(this).prev().prev().find("span").css("color", "blue");
  });
});
